...
| Incapacitation | 1.10.0 | `KnockoutActor()`, `WakeActor()`, `IsManagedUnconscious()`, `RegisterForActorWoke()`, `UnregisterForActorWoke()`, `RegisterForActorWokeAlias()`, `UnregisterForActorWokeAlias()`, event `OnActorWoke` |
