...
| Incapacitation | 1.10.0 (usable from 1.11.0 - see below) | `KnockoutActor()`, `WakeActor()`, `IsManagedUnconscious()`, `GetActorLifeState()`, `RegisterForActorWoke()`, `UnregisterForActorWoke()`, `RegisterForActorWokeAlias()`, `UnregisterForActorWokeAlias()`, event `OnActorWoke` |
